...
class TestNotifier(unittest.TestCase):
    ...
    def test_check_pumps(self):
        ...
        self.assertEqual(deviation_notifier.check_pumps(base_on, 35, 3), (2, 5))
    ...
    def test_check_length(self):
        ...
        for idx in range(1, 10):
            times = np.append(times, [datetime.datetime(2019, month=11, day=7, hour=12, minute=idx, second=0,
                                                        microsecond=0)])                                   
            '''
        ...
        self.assertTrue(deviation_notifier.check_length(timestamps, 2))
        self.assertFalse(deviation_notifier.check_length(timestamps, 3))
